...
Shader "ASESampleShaders/ObjectNormalRefraction"
{
	Properties
	{
		...
		_OpacityNoiseMult1("OpacityNoiseMult", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( ( texCUBENode45 * _Refl ) + ( temp_output_77_0 + ( tex2DNode79 * _OpacityNoiseMult1 ) + _MinusOpacity1 ) ).rgb;
			float2 uv_OpacityTex1 = i.uv_texcoord * _OpacityTex1_ST.xy + _OpacityTex1_ST.zw;
			float4 clampResult78 = clamp( ( tex2D( _OpacityTex1, uv_OpacityTex1 ) * _Opacity1 ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			o.Alpha = ( ( temp_output_77_0 * clampResult78 ) + ( tex2DNode79 * 0.0 ) ).r;
...
/*ASEBEGIN
Version=18900
25;500;1571;879;1355.439;-282.304;1.3;True;True
...
Node;AmplifyShaderEditor.SamplerNode;66;-1096.488,891.1111;Inherit;True;Property;_OpacityTex1;OpacityTex;3;0;Create;True;0;0;0;False;0;False;-1;None;459d8268ad2f9454c81abaa3bc6f3408;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-1524.851,1381.877;Float;False;Property;_OpacityNoiseMult1;OpacityNoiseMult;13;0;Create;True;0;0;0;False;0;False;0.5;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;75;-1073.37,697.3728;Float;False;Property;_Color1;Color;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2169811,0.2169811,0.2169811,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-220.7261,937.1915;Inherit;False;Property;_MinusOpacity1;MinusOpacity;17;0;Create;True;0;0;0;False;0;False;-0.112;-0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;78;-397.5493,1134.461;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;89;577.3238,135.5528;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=8E670258621C86AE00FFD43938C5B32DEFF03735