...
Shader "ASESampleShaders/ObjectNormalRefraction"
{
	Properties
	{
		...
		_Float0("Float 0", Range( 0 , 2)) = 0.5
		_IndexofRefraction("Index of Refraction", Range( -3 , 4)) = 1
		_OpacityNoiseMult("OpacityNoiseMult", Range( 0 , 2)) = 0.5
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 appendResult63 = (float4(( _Time.x * _ShieldAnimSpeedA ) , ( _Time.x * _ShieldAnimSpeedB ) , 0.0 , 0.0));
			float2 uv_TexCoord69 = i.uv_texcoord + ( appendResult63 * _NoAnimMainTex ).xy;
			float4 temp_output_77_0 = ( _Color * tex2D( _Albedo, uv_TexCoord69 ) * 4.0 );
			float2 uv_TexCoord72 = i.uv_texcoord + appendResult63.xy;
			float4 tex2DNode79 = tex2D( _OpacityNoiseTex, uv_TexCoord72 );
			float4 clampResult93 = clamp( ( ( texCUBENode45 * _Refl ) + ( temp_output_77_0 + ( tex2DNode79 * _OpacityNoiseMult ) + _MinusOpacity ) ) , float4(-0.1,-0.1,-0.1,-0.1) , float4(1000,1000,1000,1000) );
			o.Emission = clampResult93.rgb;
			float2 uv_OpacityTex = i.uv_texcoord * _OpacityTex_ST.xy + _OpacityTex_ST.zw;
			float4 temp_output_68_0 = ( tex2D( _OpacityTex, uv_OpacityTex ) * _Float0 );
...
/*ASEBEGIN
Version=18900
-259;236;1571;855;244.111;163.639;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-2511.248,1080.003;Float;False;Property;_ShieldAnimSpeedB;Shield Anim SpeedB;15;0;Create;True;0;0;0;False;0;False;3;0;-10;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;60;-2402.695,726.1425;Float;False;Property;_ShieldAnimSpeedA;Shield Anim SpeedA;14;0;Create;True;0;0;0;False;0;False;3;3.3;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-1958.327,1086.05;Inherit;False;Property;_NoAnimMainTex;NoAnimMainTex;16;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;65;-967.4004,1197.854;Float;False;Property;_Float0;Float 0;11;0;Create;True;0;0;0;False;0;False;0.5;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;79;-1829.323,1290.33;Inherit;True;Property;_OpacityNoiseTex;OpacityNoiseTex;5;0;Create;True;0;0;0;False;0;False;-1;None;459d8268ad2f9454c81abaa3bc6f3408;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;76;-1524.851,1381.877;Float;False;Property;_OpacityNoiseMult;OpacityNoiseMult;13;0;Create;True;0;0;0;False;0;False;0.5;1.3;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;75;-1073.37,697.3728;Float;False;Property;_Color;Color;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1792453,0.1792453,0.1792453,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;71;-1383.219,580.2927;Inherit;True;Property;_Albedo;Albedo;7;0;Create;True;0;0;0;False;0;False;-1;None;54d7aec97cb916047b0ef2fe9e52a349;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;73;-704.449,867.1989;Inherit;False;Constant;_Float1;Float 1;12;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;66;-1096.488,891.1111;Inherit;True;Property;_OpacityTex;OpacityTex;3;0;Create;True;0;0;0;False;0;False;-1;None;0d8a26cec82234c4f843595e1ae00caa;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-220.7261,937.1915;Inherit;False;Property;_MinusOpacity;MinusOpacity;17;0;Create;True;0;0;0;False;0;False;-0.112;-0.76;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;80;-280.5204,1433.443;Inherit;False;Constant;_adddd;adddd;10;0;Create;True;0;0;0;False;0;False;0;-0.83;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;96;-36.66679,410.9913;Inherit;False;Constant;_Vector1;Vector 1;19;0;Create;True;0;0;0;False;0;False;1000,1000,1000,1000;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;95;-6.866772,191.4913;Inherit;False;Constant;_Vector0;Vector 0;19;0;Create;True;0;0;0;False;0;False;-0.1,-0.1,-0.1,-0.1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;93;648.3954,125.5596;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;94;646.6495,334.2504;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;41;571.5358,238.9575;Float;False;Property;_IndexofRefraction;Index of Refraction;12;0;Create;True;0;0;0;False;0;False;1;1.2;-3;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;85;-120.3739,614.2145;Inherit;True;Property;_Normal;Normal;9;0;Create;True;0;0;0;False;0;False;-1;None;302951faffe230848aa0d3df7bb70faa;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-94.70272,1046.212;Inherit;False;Property;_Blesk;Blesk;18;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;98;744.097,-26.3259;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;86;82.89262,988.0955;Inherit;False;Constant;_Float2;Float 2;12;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;97;640.4271,48.74566;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;863.3,35.80001;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;ASESampleShaders/ObjectNormalRefraction;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;3;False;-1;False;0;False;-1;0;False;-1;False;0;Translucent;0.5;True;True;0;False;Opaque;;Transparent;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;0;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.2;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=394ED707CDB1C75CA2F897273347948394928D29