...
Shader "ASESampleShaders/PeopleSegmentedShader"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half4 temp_output_246_0 = ( tex2Dlod( _Albedo1, float4( uv_Albedo1, 0, 0.0) ) * tex2Dlod( _CheckersA1, float4( uv_TexCoord337, 0, 0.0) ) * tex2Dlod( _CheckersB1, float4( uv_TexCoord338, 0, 0.0) ) );
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			half2 temp_cast_4 = (0.4).xx;
			half temp_output_262_0 = ( _SinTime.x * _AnimDivB1 );
			half2 temp_cast_5 = (temp_output_262_0).xx;
			float2 uv_TexCoord337 = i.uv_texcoord * temp_cast_4 + temp_cast_5;
			half2 temp_cast_6 = (0.4).xx;
			half temp_output_266_0 = ( _CosTime.x * _AnimDivC1 );
			half2 temp_cast_7 = (temp_output_266_0).xx;
			float2 uv_TexCoord338 = i.uv_texcoord * temp_cast_6 + temp_cast_7;
			half4 temp_output_246_0 = ( tex2D( _Albedo1, uv_Albedo1 ) * tex2D( _CheckersA1, uv_TexCoord337 ) * tex2D( _CheckersB1, uv_TexCoord338 ) );
			half4 temp_output_251_0 = ( _DissolveAmount1 + ( temp_output_246_0 * _DissolveMul ) );
			...
			half4 temp_output_182_0 = ( clampResult171 + ( half4( appendResult193 , 0.0 ) * _FrColorA * temp_output_335_0 ) + ( half4( appendResult306 , 0.0 ) * _FrColorB * temp_output_335_0 ) + ( half4( appendResult327 , 0.0 ) * _FrColorC * temp_output_335_0 ) + ( ( half4( appendResult193 , 0.0 ) * _FrColorA ) + ( half4( appendResult306 , 0.0 ) * _FrColorB ) + ( half4( appendResult327 , 0.0 ) * _FrColorC ) ) );
			...
			half4 temp_output_283_0 = ( ( break197.r + break197.g + break197.b ) + ( tex2DNode181 * clampResult282 ) );
...
/*ASEBEGIN
Version=18900
65;398;1571;981;-952.0822;-1256.076;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;259;1290.809,1859.542;Inherit;False;Property;_AnimDivB1;AnimDivB;28;0;Create;True;0;0;0;False;0;False;0.15;0.65;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;261;1266.386,2118.607;Inherit;False;Property;_AnimDivC1;AnimDivC;31;0;Create;True;0;0;0;False;0;False;0.15;-0.65;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;339;1694.082,1815.076;Inherit;False;Constant;_Float3;Float 3;46;0;Create;True;0;0;0;False;0;False;0.4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;311;683.7038,798.2166;Inherit;False;Property;_FrMulB;FrMulB;5;0;Create;True;0;0;0;False;0;False;10;203999;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;272;725.7534,189.0855;Inherit;False;Property;_FrMulMinusA;FrMulMinusA;8;0;Create;True;0;0;0;False;0;False;-2;-250;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;271;668.9074,449.011;Inherit;False;Property;_FrMulA;FrMulA;3;0;Create;True;0;0;0;False;0;False;10;4659;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;329;688.951,900.4106;Inherit;False;Property;_FrMulMinusC;FrMulMinusC;6;0;Create;True;0;0;0;False;0;False;-2;-800;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;315;724.4596,1146.167;Inherit;False;Property;_FrMulC;FrMulC;4;0;Create;True;0;0;0;False;0;False;10;39999;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;245;2143.924,1836.338;Inherit;True;Property;_CheckersB1;CheckersB;14;0;Create;True;0;0;0;False;0;False;-1;None;b3792c50aed9465489732cb8962693ec;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;242;2161.103,1499.169;Inherit;True;Property;_CheckersA1;CheckersA;9;0;Create;True;0;0;0;False;0;False;-1;None;b3792c50aed9465489732cb8962693ec;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;241;2755.22,1460.248;Float;False;Property;_DissolveAmount1;Dissolve Amount;24;0;Create;True;0;0;0;False;0;False;0;-1.71;-5;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;326;1523.351,1062.017;Inherit;False;Property;_FrColorC;FrColorC;45;0;Create;True;0;0;0;False;0;False;1,0.0518868,0.0518868,0;0,0.6132076,0.1886848,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;307;1535.356,715.3224;Inherit;False;Property;_FrColorB;FrColorB;44;0;Create;True;0;0;0;False;0;False;1,0.0518868,0.0518868,0;0.2772326,0,0.3207547,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;172;1151.126,-432.3254;Inherit;False;Property;_Frenc;Frenc;36;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;297;1555.47,364.7432;Inherit;False;Property;_FrColorA;FrColorA;43;0;Create;True;0;0;0;False;0;False;1,0.0518868,0.0518868,0;0.7372549,0,0.00707847,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;186;2043.933,253.6198;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;COLOR;1,1,1,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;328;2011.814,950.8934;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;COLOR;1,1,1,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;334;1807.758,473.0796;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;308;2023.819,604.1988;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;COLOR;1,1,1,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;282;2009.24,37.31922;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;198;2048.658,-414.1475;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;230;2216.89,-221.868;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;1,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;1798.356,1624.829;Inherit;False;Constant;_Float5;Float 4;10;0;Create;True;0;0;0;False;0;False;99;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;264;1741.933,1986.894;Inherit;False;Constant;_Float4;Float 3;10;0;Create;True;0;0;0;False;0;False;99;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=50655DED963754FA823F42A5FB5B0D38288AF698