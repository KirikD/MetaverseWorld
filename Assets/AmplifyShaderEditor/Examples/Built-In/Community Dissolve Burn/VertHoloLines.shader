...
Shader "ASESampleShaders/Community/TOPFlatProjection 1"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_173_0 = (ase_vertex4Pos).y;
			...
			float4 tex2DNode2 = tex2Dlod( _DisolveGuide1, float4( temp_output_182_0.xy, 0, 1.0) );
			float temp_output_73_0 = ( (-0.6 + (( 1.0 - _DissolveAmount ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + tex2DNode2.r );
...
/*ASEBEGIN
Version=18900
466;441;1514;591;2205.513;-715.9872;1.424102;True;True
...
Node;AmplifyShaderEditor.ComponentMaskNode;173;-1449.658,820.3851;Inherit;False;False;True;False;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;186;-1197.249,903.9229;Inherit;False;Property;_SizeLines;SizeLines;11;0;Create;True;0;0;0;False;0;False;999;500;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;188;-1560.229,1118.253;Inherit;False;Property;_AnimDivB;AnimDivB;13;0;Create;True;0;0;0;False;0;False;0.15;1;-1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-919.0424,582.2975;Float;False;Property;_DissolveAmount;Dissolve Amount;7;0;Create;True;0;0;0;False;0;False;0;0.525;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-643.3626,768.1237;Inherit;True;Property;_DisolveGuide1;Disolve Guide1;4;0;Create;True;0;0;0;False;0;False;-1;0bbd24355cfb3074392f4e25176bc9da;64e7766099ad46747a07014e44d0aea1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;191;-61.25727,208.3168;Inherit;False;Property;_ColorEmiss;ColorEmiss;15;0;Create;True;0;0;0;False;0;False;0,0.3679245,0.2178739,0;0,0.3679245,0.2178739,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;162;428.7297,-194.9904;Inherit;False;Property;_ColorMain;ColorMain;12;0;Create;True;0;0;0;False;0;False;0.2520217,1,0.1273585,0;0.2520217,1,0.1273585,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;193;-1447.652,1370.318;Inherit;False;Property;_AnimDivC;AnimDivC;14;0;Create;True;0;0;0;False;0;False;0.15;0.15;-1;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=7A88E66D38CD9B2B2CCF06694216A1210D955C4B