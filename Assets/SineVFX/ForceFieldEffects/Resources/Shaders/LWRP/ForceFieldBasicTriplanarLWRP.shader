    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN , half ase_vface : VFACE) : SV_Target
            {
				...
				#endif
				float4 break58 = ( float4( ( FinalWorldPosition102 * _Noise01Tiling ) , 0.0 ) + ( _Time.y * _Noise01ScrollSpeed ) + staticSwitch42 );
				...
				float4 break51 = ( float4( ( FinalWorldPosition102 * _Noise02Tiling ) , 0.0 ) + ( _Time.y * _Noise02ScrollSpeed ) + staticSwitch42 );
				...
				#endif
				float2 uv0_MaskAppearNoise = IN.ase_texcoord7.xyz * _MaskAppearNoise_ST.xy + _MaskAppearNoise_ST.zw;
				float4 triplanar303 = TriplanarSamplingSF( _MaskAppearNoise, ase_worldPos, ase_worldNormal, 1.0, _MaskAppearNoiseTriplanarTiling, 1.0, 0 );
        ...
        Pass
        {
            ...
            half4 frag( VertexOutput IN , half ase_vface : VFACE ) : SV_TARGET
            {
				...
				float staticSwitch118 = temp_output_109_0;
				#endif
				float2 uv0_MaskAppearNoise = IN.ase_texcoord6.xy * _MaskAppearNoise_ST.xy + _MaskAppearNoise_ST.zw;
				float4 triplanar303 = TriplanarSamplingSF( _MaskAppearNoise, ase_worldPos, ase_worldNormal, 1.0, _MaskAppearNoiseTriplanarTiling, 1.0, 0 );
				#ifdef _MASKAPPEARNOISETRIPLANAR_ON
				float staticSwitch304 = triplanar303.x;
				#else
...
/*ASEBEGIN
Version=17200
7;7;1906;1005;-256.3741;768.4209;1.267308;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;103;-2550.102,531.3108;Float;False;Property;_LocalNoisePosition;Local Noise Position;3;0;Create;True;0;0;False;0;0;0;1;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ObjectScaleNode;386;310.5185,2356.182;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.PowerNode;15;-250.197,799.4316;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;6;119.1042,249.224;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;390;1914.879,-396.0403;Float;False;True;2;ASEMaterialInspector;0;3;SineVFX/ForceFieldAndShieldEffects/ForceFieldBasicTriplanarLWRP;e2514bdcf5e5399499a9eb24d175b9db;True;Base;0;0;Base;5;False;False;False;True;2;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;;0;0;Standard;4;Vertex Position,InvertActionOnDeselection;1;Receive Shadows;0;Built-in Fog;0;LOD CrossFade;0;0;3;True;False;True;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;391;1914.879,-396.0403;Float;False;False;2;ASEMaterialInspector;0;1;Hidden/Templates/LightWeightSRPUnlit;e2514bdcf5e5399499a9eb24d175b9db;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;False;False;False;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;392;1914.879,-396.0403;Float;False;False;2;ASEMaterialInspector;0;1;Hidden/Templates/LightWeightSRPUnlit;e2514bdcf5e5399499a9eb24d175b9db;True;DepthOnly;0;2;DepthOnly;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;False;False;False;True;False;False;False;False;0;False;-1;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=DepthOnly;True;0;0;;0;0;Standard;0;0
...
WireConnection;390;3;341;0
ASEEND*/
//CHKSM=9664962624FF92219F603BF64C2685FEA87328D7