...
Shader "FrancelSimple"
{
	Properties
	{
		_MainCol("MainCol", Color) = (0,0.1280145,0.2830189,0)
		_FrColor("FrColor", Color) = (0,0.007030964,1,0)
		_M("M", Float) = 0
		_Ftt("Ftt", Float) = 0
		_Sm("Sm", Float) = 0
		_Textu("Textu", 2D) = "white" {}
	...
	LOD 0
		...
		Pass
		{
			...
			struct v2f {
				...
				float _TessMaxDisp;
			#endif
			uniform sampler2D _Textu;
			uniform float4 _Textu_ST;
				...
				) : SV_Target 
			{
				...
				float2 uv_Textu = IN.ase_texcoord9.xy * _Textu_ST.xy + _Textu_ST.zw;
				float fresnelNdotV6 = dot( WorldNormal, worldViewDir );
				float fresnelNode6 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV6, 5.0 ) );
				float4 clampResult14 = clamp( ( _FrColor * fresnelNode6 * _Ftt ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
				
				o.Albedo = ( tex2D( _Textu, uv_Textu ) * ( clampResult14 + _MainCol ) ).rgb;
		...
		Pass
		{
			...
			) 
			{
				...
				float2 uv_Textu = IN.ase_texcoord8.xy * _Textu_ST.xy + _Textu_ST.zw;
				float fresnelNdotV6 = dot( WorldNormal, worldViewDir );
				float fresnelNode6 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV6, 5.0 ) );
				float4 clampResult14 = clamp( ( _FrColor * fresnelNode6 * _Ftt ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
		...
		Pass
		{
				...
				) : SV_Target 
			{
				...
				float2 uv_Textu = IN.ase_texcoord3.xy * _Textu_ST.xy + _Textu_ST.zw;
...
/*ASEBEGIN
Version=18900
256;363;1514;722;681.9735;327.4249;1;True;True
Node;AmplifyShaderEditor.FresnelNode;6;-633.4215,13.29063;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;122.0265,-29.42493;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-285.4215,25.29063;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-357.446,190.9565;Inherit;False;Property;_Ftt;Ftt;3;0;Create;True;0;0;0;False;0;False;0;14.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;65.60767,182.1143;Inherit;False;Property;_M;M;2;0;Create;True;0;0;0;False;0;False;0;-0.59;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;14;-147.0919,73.94431;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;10;-254.7278,318.0715;Inherit;False;Property;_MainCol;MainCol;0;0;Create;True;0;0;0;False;0;False;0,0.1280145,0.2830189,0;0.4150943,0.3531703,0.2878248,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;7;-610.5634,242.4041;Inherit;False;Property;_FrColor;FrColor;1;0;Create;True;0;0;0;False;0;False;0,0.007030964,1,0;0,0.007030964,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;9;18.74713,91.12141;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;12;81.60767,281.1143;Inherit;False;Property;_Sm;Sm;4;0;Create;True;0;0;0;False;0;False;0;0.81;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-210.9735,-205.4249;Inherit;True;Property;_Textu;Textu;6;0;Create;True;0;0;0;False;0;False;-1;None;9446b50bedc24c444b6c1f7f5786729d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;331.3472,-1.134751;Float;False;True;-1;2;ASEMaterialInspector;0;10;FrancelSimple;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;18;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;40;Workflow,InvertActionOnDeselection;1;Surface;0;  Blend;0;  Refraction Model;0;  Dither Shadows;1;Two Sided;1;Deferred Pass;1;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Ambient Light;1;Meta Pass;1;Add Pass;1;Override Baked GI;0;Extra Pre Pass;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Fwd Specular Highlights Toggle;0;Fwd Reflections Toggle;0;Disable Batching;0;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=FF023451BE0A2E769CF9F46D7995D235F5970841